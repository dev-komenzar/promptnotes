...
- **NoteFeed**（read model 候補）
  ...
  - **検索範囲決定**（2026-06-16, Q7）:
    ...
    - マッチング: case-insensitive substring + NFKC (compatibility normalization) 正規化（regex / wildcard は Non-Goal）
...
- Q7: 検索の対象範囲 → 本文 + タグのみ、case-insensitive + NFKC (compatibility normalization)
