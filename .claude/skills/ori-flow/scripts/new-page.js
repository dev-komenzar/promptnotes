...
// packages/skills/ori-flow/src/new-page.ts
...
var cwd = process.cwd();
var dir = join(cwd, ".ori/pages", id);
if (await exists(dir)) {
  consola.error(`Page already exists: .ori/pages/${id}`);
  process.exit(1);
}
await mkdir(dir, { recursive: true });
var tpl = await loadTemplate("page-manifest.yaml.tpl");
var manifestContent;
if (tpl) {
...
var status = {
  ...
  beads: { epic: formatEpicId("page", id), current_phase: null, completion: [] },
  phases: {},
  dirty: []
};
